...
### Fixed
- The brand logo 404'd in the container — `static/logo.svg` wasn't being copied into the image (the Dockerfile copies static assets individually). Added the missing `COPY`.
