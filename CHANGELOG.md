...
### Added
- **Community: we're on Discord.** A "Join the Discord" button in the dashboard sidebar (a small social bar, ready to grow as more channels go live) and a Community section + badge in the README. Come chat, share ideas, and help shape the roadmap: <https://discord.gg/sRSHFytWQ>
